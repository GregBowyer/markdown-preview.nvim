...
GH_REPO="$GH_API/repos/GregBowyer/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/GregBowyer/markdown-preview.nvim/releases/$id/assets?name=$filename"
